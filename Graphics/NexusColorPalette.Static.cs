...
public sealed partial class NexusColorPalette
{
    ...
    public static NexusColorPalette FromImage(string filepath) => FromImage((Bitmap)Image.FromFile(filepath));
    ...
    public static NexusColorPalette FromImage(Uri url)
    {
    ...
    /// <returns><see cref="NexusColorPalette"/></returns>
    public static NexusColorPalette FromImage(Bitmap bitmap)
    {
