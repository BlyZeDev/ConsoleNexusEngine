...
public readonly partial record struct NexusColor
{
    ...
    /// [R=255,G=255,B=255]
    /// </summary>
    public static NexusColor White => new(0xFFFFFF);

    /// <summary>
    /// [R=0,G=0,B=0]
    /// </summary>
    public static NexusColor Black => new(0x000000);

    /// <summary>
    /// [R=255,G=0,B=0]
    /// </summary>
    public static NexusColor Red => new(0xFF0000);

    /// <summary>
    /// [R=0,G=255,B=0]
    /// </summary>
    public static NexusColor Green => new(0x00FF00);

    /// <summary>
    /// [R=0,G=0,B=255]
    /// </summary>
    public static NexusColor Blue => new(0x0000FF);

    /// <summary>
    /// [R=255,G=0,B=255]
    /// </summary>
    public static NexusColor Magenta => new(0xFF00FF);

    /// <summary>
    /// [R=255,G=255,B=0]
    /// </summary>
    public static NexusColor Yellow => new(0xFFFF00);

    /// <summary>
    /// [R=0,G=255,B=255]
    /// </summary>
    public static NexusColor Cyan => new(0x00FFFF);
